...
_LANGUAGES = ["zh"]
class BQ(AbsTaskPairClassification):
    @property
    def description(self):
        return {
            "name": "BQ",
            "hf_hub_name": "shibing624/nli_zh",
            "description": "NLI",
            "reference": "https://huggingface.co/datasets/shibing624/nli_zh/",
            "category": "s2s",
    ...
    def load_data(self, **kwargs):
        ...
        self.dataset = datasets.load_dataset(
            self.description["hf_hub_name"],name="BQ", revision=self.description.get("revision", None)
        )
...
class LCQMC(AbsTaskPairClassification):
    @property
    def description(self):
        return {
            "name": "LCQMC",
    ...
    def load_data(self, **kwargs):
        ...
        # TODO: add split argument
        self.dataset = datasets.load_dataset(
            self.description["hf_hub_name"],name="LCQMC", revision=self.description.get("revision", None)
        )
        self.data_loaded = True
